...
Mobilio mainly has two components i.e a server side app and an android app (UI). The web app is written on the Java stack using technologies and frameworks like Bootstrap, Java 8, Spring 4.2, JPA 2.0, MySQL database.
